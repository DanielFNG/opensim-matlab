function inverseModelNoSlack0Eq(pathToData, timesteps, multiplier) 
...
link = 0.35;
%timesteps = 119;
%multiplier is what multiplies the left & right hip joints for
%reduction/addition to the joint torques
...
saved_results = zeros(timesteps,25);
...
for i=1:timesteps
    ...
    C = zeros(46,25);
    C = [right_apo_normalised, left_apo_normalised, eye(23); 
            zeros(23,2), eye(23)]; 
    ...
    [x,resnorm,residual,exitflag] = lsqlin(C,d,A_ineq,b_ineq);
