//==============================================================================
//							getGeneralisedForces.cpp
//
//Code using the OpenSim C++ API to, given the results of an RRA analysis on some OpenSim
//model file and the raw GRF data, calculate the generalized force components comprising the 
//classical equation of motion i.e.
//
//				M(q)q.. + C(q,q.) + g(q) = tau + F,
// 
//From left to right, we have generalized forces due to: 
//
//	-	inertia,
...
//
//This function calculates these generalized forces, checks that they satisfy the classical
