function inverseModelNoSlack2Eq_hardcodedAPOdesired(pathToData, timesteps, multiplier)

% Hardcoded APO-desired. 
...
saved_errors = zeros(timesteps,23);
...
for i=1:timesteps
    ...
    C = zeros(23,48);
    C = [zeros(23,2), zeros(23), eye(23)];
    
    d = zeros(23,1);
    for joint=1:23
        d(joint,1) = net_internal(i,joint) ...
                    - multiplier*right_apo_normalised(joint,1) ...
                    - multiplier*left_apo_normalised(joint,1);
    end
    saved_desired(i,1:end) = d(1:end,1);
    
    A_eq = zeros(46,48);
    A_eq = [zeros(23,2), eye(23), eye(23); -[right_apo_normalised, left_apo_normalised], eye(23), zeros(23)];
    
    b_eq = zeros(46,1);
    b_eq(1:23,1) = net_internal(i,1:23);
...
SAVE_FOLDER = [pathToData, '/apo_multiplier=', num2str(multiplier)];
mkdir(SAVE_FOLDER)
