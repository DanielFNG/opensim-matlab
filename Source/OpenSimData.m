classdef OpenSimData < handle & matlab.mixin.Copyable
    ...
    methods (Access = private)        
        ...
        function loadTRC(obj)
        
            [header, labels, str_values] = Data.splitTRC(obj.File);
    ...
    methods (Static)
        ...
        function [Header, Labels, str_values] = splitTRC(filename)
