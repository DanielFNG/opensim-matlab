...
for i=1:10
    ...
    cohens_d_avged(1,i) = metrics{i}.calcAbsCohensD();
    cohens_d_avged_assistance(1,i) = metrics{i}.calcAbsCohensD('A');
    cohens_d_avged_context(1,i) = metrics{i}.calcAbsCohensD('C');
end
...
xlabel('Metric');
title('Cohen''s D averaged over all significant differences');
...
ylabel('Averaged Cohen''s D');
xlabel('Metric');
title('Cohen''s D for significant differences due to changing assistance');
...
ylabel('Averaged Cohen''s D');
xlabel('Metric');
title('Cohen''s D for significant differences due to changing contexts');
